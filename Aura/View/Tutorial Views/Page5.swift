...
class Page5: UIView {
    ...
    var questionHeader: UILabel = {
        let l = UILabel()
        l.text = NSLocalizedString("Now let's look at it in English HD", comment: "Let us look at the word banana in English  HD")
        l.numberOfLines = 1
    ...
    var bananaLabel: UILabel = {
        ...
        text1.addAttribute(.foregroundColor, value: K.Colors.lightPink, range: .init(location: 1, length: 1))
        text1.addAttribute(.foregroundColor, value: K.Colors.lightPink, range: .init(location: 5, length: 1))
        text1.addAttribute(.foregroundColor, value: K.Colors.red, range: .init(location: 3, length: 1))
        l.attributedText = text1
    ...
    var buttons: [UIView] = {
        ...
        var arr = [UIView]()
        let colors = [K.Colors.green, K.Colors.lightPink, K.Colors.darkGreen, K.Colors.orange, K.Colors.pink, K.Colors.red, K.Colors.seaBlue]
    ...
    func showSolutionLabel(isRight: Bool) {
        if isRight {
            ...
            solutionLabel.text = NSLocalizedString("Try Again!", comment: "You got the anser wrong, try again")
